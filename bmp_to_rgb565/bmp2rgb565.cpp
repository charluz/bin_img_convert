...
static unsigned is_swapEndian = 0;	// default little-endian
...
int main(int argc, char *argv[])
{
	...
	//printf("---- RGB565 endina: %s-endian\n", (is_swapEndian ? "big":"little"));
...
//	printf("openning bmp fname : %s\n", psz_fnbmp);
	...
	char postfix[32];
	snprintf(postfix, 32, "_%dx%d_Xrgb565", hsize, vsize);
